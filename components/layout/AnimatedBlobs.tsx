export function AnimatedBlobs() {
  return (
    <div className="fixed inset-0 z-0">
      ...
      />
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[220px] h-[220px] rounded-full opacity-60 animate-blob animation-delay-6000"
        style={{
